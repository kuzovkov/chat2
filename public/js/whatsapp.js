...
// based on the 'messages' in the datastore
    ...
    let viewChatList = () => {
        ...
        chatList
            ...
            .forEach((elem, index) => {
                ...
                DOM.chatList.innerHTML += `
		<div class="chat-list-item d-flex flex-row w-100 p-2 border-bottom" onclick="I.whatsapp.generateMessageArea(this, ${index})">
			<img src="" alt="Profile Photo" class="img-fluid rounded-circle mr-2" style="height:50px;">
			<div class="w-50">
   ...
   let hideProfileSettings = () => {
    ...
    let init = () => {
        ...
        DOM.profilePic.addEventListener("click", () => I.whatsapp.DOM.profilePicInput.click());
        DOM.profilePicInput.addEventListener("change", () => console.log(I.whatsapp.DOM.profilePicInput.files[0]));
    ...
    function inner() {
        return {
            DOM:DOM,
            generateChatList: generateChatList,
            showProfileSettings: showProfileSettings,
            hideProfileSettings: hideProfileSettings,
            addMessageToMessageArea: addMessageToMessageArea,
            chatList: chatList,
            sendMessage: sendMessage,
            populateChatList: populateChatList,
            viewChatList: viewChatList,
            generateMessageArea: generateMessageArea,
            init: init
        };
    };
    whatsapp = inner;
